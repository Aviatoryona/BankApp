<?php
session_start();
if (isset($_GET['q']) || !isset($_SESSION['admin'])) {
    session_destroy();
    header("location: ./");
}
?>
    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
            ...
            <div class="w3-padding-64 w3-medium w3-text-grey" style="font-weight:bold">
                <a href="javascript:void(0)" class="w3-bar-item w3-button" onclick="admin.totalProfit()">Home</a>
                <a href="javascript:void(0)" class="w3-bar-item w3-button" onclick="admin.clients()">Clients</a>
                <a href="javascript:void(0)" class="w3-bar-item w3-button" onclick="admin.transactions()">Transactions</a>
            </div>
            <a href="admin.php?q=90" class="w3-bar-item w3-button w3-padding">Log Out</a>
        </nav>
